...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => C("UPLOAD_SCRIPT_URL") . "/",
            'upload_dir' => C("UPLOAD_DIR") . '/',
            'upload_url' => C("UPLOAD_DIR") . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'max_file_size' => C("UPLOAD_MAX_FILE_SIZE"),
            'min_file_size' => 1,
    ...
    protected function header($str) {
        Log::record("header: " . $str, Log::DEBUG);
        header($str);
    ...
    protected function download() {
        ...
        Log::record("file name: " . $file_name, Log::DEBUG);
        if ($redirect_header) {
            return $this->header(
